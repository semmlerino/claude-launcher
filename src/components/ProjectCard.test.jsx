...
describe('ProjectCard', () => {
  ...
  describe('Edit mode', () => {
    test('enters edit mode when clicking edit button', () => {
      ...
      expect(screen.getByDisplayValue('This is a test project for unit testing')).toBeInTheDocument();
    });
  ...
  describe('Saving edits', () => {
    ...
    test('shows loading spinner during save', () => {
      ...
      const { rerender } = renderWithTheme(<ProjectCard project={defaultProject} {...mockHandlers} />);
  ...
  describe('Keyboard focus and selected state', () => {
    test('applies hover effect on card', () => {
      const { container } = renderWithTheme(<ProjectCard project={defaultProject} {...mockHandlers} />);
